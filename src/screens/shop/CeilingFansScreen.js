...
const CARD_W=W/2;
const SUBS=[{label:'DC MOTOR FANS',products:[
  {id:1,name:'CEILING FAN DC 52"',sub:'Silent DC motor with remote',price:'199.95',was:'249.95',off:20,badge:null,bg:'#EDE8F5'},
  {id:2,name:'DC FAN WITH LIGHT',sub:'LED DC ceiling fan 52"',price:'229.95',was:'289.95',off:21,badge:null,bg:'#E8F0F5'},
  {id:3,name:'DC FAN SILENT',sub:'Ultra quiet DC fan 48"',price:'249.95',was:'319.95',off:22,badge:null,bg:'#F5EDE8'},
  {id:4,name:'DC FAN REMOTE',sub:'6-speed DC fan with remote',price:'179.95',was:'224.95',off:20,badge:null,bg:'#EEF5E8'}
]},
{label:'LED FANS',products:[
  {id:5,name:'LED FAN 42"',sub:'LED ceiling fan with dimmer',price:'169.95',was:'219.95',off:23,badge:null,bg:'#E8F0F5'},
  {id:6,name:'LED FAN DIMMABLE',sub:'Adjustable LED light fan',price:'189.95',was:'239.95',off:21,badge:null,bg:'#EDE8F5'},
  {id:7,name:'LED FAN RGB',sub:'Color changing LED fan',price:'219.95',was:'279.95',off:21,badge:null,bg:'#F5EDE8'},
  {id:8,name:'LED FAN SLIM',sub:'Low profile LED fan',price:'149.95',was:'189.95',off:21,badge:null,bg:'#EEF5E8'}
]},
{label:'OUTDOOR FANS',products:[
  {id:9,name:'OUTDOOR FAN 52"',sub:'Weatherproof outdoor fan',price:'229.95',was:'289.95',off:21,badge:null,bg:'#E8F5EE'},
  {id:10,name:'OUTDOOR FAN IP44',sub:'IP44 rated patio fan',price:'249.95',was:'314.95',off:21,badge:null,bg:'#F5EDE8'},
  {id:11,name:'OUTDOOR FAN TEAK',sub:'Teak blade outdoor fan',price:'279.95',was:'349.95',off:20,badge:null,bg:'#EDE8F5'},
  {id:12,name:'OUTDOOR FAN MINI',sub:'Compact outdoor fan 36"',price:'179.95',was:'224.95',off:20,badge:null,bg:'#E8F0F5'}
]},
{label:'SMART FANS',products:[
  {id:13,name:'SMART FAN WIFI',sub:'WiFi ceiling fan with app',price:'279.95',was:'349.95',off:20,badge:null,bg:'#F5F0E8'},
  {id:14,name:'SMART FAN ALEXA',sub:'Alexa compatible smart fan',price:'299.95',was:'379.95',off:21,badge:null,bg:'#E8EDF5'},
  {id:15,name:'SMART FAN GOOGLE',sub:'Google Home smart fan',price:'319.95',was:'399.95',off:20,badge:null,bg:'#EEF5E8'},
  {id:16,name:'SMART FAN APP',sub:'App controlled smart fan',price:'259.95',was:'329.95',off:21,badge:null,bg:'#F5EDE8'}
]}];
...
export default function CeilingFansScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>UP TO -20%  |  CEILING FANS</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>32 products</Text>
