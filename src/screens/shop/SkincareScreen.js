...
const CARD_W=W/2;
const SUBS=[{label:'FACE DEVICES',products:[
  {id:1,name:'LED FACE MASK',sub:'7-colour LED therapy',price:'79.95',was:'99.95',off:20,badge:'NEW',bg:'#F5E8F0'},
  {id:2,name:'FACIAL STEAMER',sub:'Nano ionic steamer',price:'39.95',was:'54.95',off:27,badge:'NEW',bg:'#F0F5E8'},
  {id:3,name:'MICRODERMABRASION',sub:'Diamond tip device',price:'89.95',was:'114.95',off:22,badge:'NEW',bg:'#E8F0F5'},
  {id:4,name:'GLOW SERUM WAND',sub:'EMS radio frequency',price:'59.95',was:'79.95',off:25,badge:'NEW',bg:'#F5F0E8'}
]},
{label:'BODY DEVICES',products:[
  {id:5,name:'BODY BRUSH SONIC',sub:'Sonic body brush',price:'49.95',was:'64.95',off:23,badge:'NEW',bg:'#EEF5E8'},
  {id:6,name:'CELLULITE MASSAGER',sub:'Anti-cellulite device',price:'69.95',was:'89.95',off:22,badge:'NEW',bg:'#F5EEE8'},
  {id:7,name:'FOOT FILE ELECTRIC',sub:'Electric foot file',price:'29.95',was:'39.95',off:25,badge:'NEW',bg:'#E8F5F0'},
  {id:8,name:'BODY TONER',sub:'EMS body toning device',price:'99.95',was:'129.95',off:23,badge:'NEW',bg:'#F5E8EE'}
]},
{label:'SETS & BUNDLES',products:[
  {id:9,name:'FACE CARE SET',sub:'Cleanser + mask + wand',price:'149.95',was:'199.95',off:25,badge:'NEW',bg:'#EDE8F5'},
  {id:10,name:'PAMPER BUNDLE',sub:'Full body care bundle',price:'179.95',was:'229.95',off:22,badge:'NEW',bg:'#F0E8F5'},
  {id:11,name:'TRAVEL BEAUTY KIT',sub:'Mini travel skincare set',price:'89.95',was:'119.95',off:25,badge:'NEW',bg:'#F5F5E8'},
  {id:12,name:'GIFT SET PREMIUM',sub:'Premium gift box',price:'129.95',was:'169.95',off:24,badge:'NEW',bg:'#E8EDF5'}
]}];
...
export default function SkincareScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>NEW IN  |  SKINCARE</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>18 products</Text>
