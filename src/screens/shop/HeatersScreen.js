...
export default function HeatersScreen({ navigate }) {
    ...
    return (
        <SafeAreaView style={s.root} edges={['top', 'bottom']}>
            ...
            <View style={s.dealsBanner}><Text style={s.dealsText}><Text style={s.bold}>UP TO -30%</Text>{' | HEATERS'}</Text><Ionicons name="information-circle-outline" size={20} color="#888888" /></View>
            ...
            <View style={s.countRow}>
                <Text style={s.countText}>48 products</Text>
