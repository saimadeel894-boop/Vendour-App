...
const CARD_W=W/2;
const SUBS=[{label:'HAIR CARE',products:[
  {id:1,name:'HAIR DRYER PRO 2200W',sub:'Professional ionic dryer',price:'59.95',was:'79.95',off:25,badge:null,bg:'#F5E8EE'},
  {id:2,name:'HAIR STRAIGHTENER',sub:'Ceramic plates 230°C',price:'49.95',was:'64.95',off:23,badge:null,bg:'#EEE8F5'},
  {id:3,name:'HAIR CURLER AUTO',sub:'Auto rotating curler',price:'54.95',was:'69.95',off:21,badge:null,bg:'#EEF5E8'},
  {id:4,name:'HAIR TRIMMER SET',sub:'10-piece trimmer kit',price:'39.95',was:'49.95',off:20,badge:null,bg:'#F5EEE8'}
]},
{label:'SKIN CARE DEVICES',products:[
  {id:5,name:'FACE MASSAGER SONIC',sub:'Sonic facial brush',price:'39.95',was:'54.95',off:27,badge:null,bg:'#F5F5E8'},
  {id:6,name:'LED FACE MASK',sub:'7-colour LED mask',price:'79.95',was:'99.95',off:20,badge:null,bg:'#F5E8F0'},
  {id:7,name:'MICRODERMABRASION',sub:'Diamond tip device',price:'89.95',was:'114.95',off:22,badge:null,bg:'#E8F0F5'},
  {id:8,name:'EYE MASSAGER',sub:'Heated eye massager',price:'49.95',was:'64.95',off:23,badge:null,bg:'#EEF5E8'}
]},
{label:'SHAVERS & EPILATORS',products:[
  {id:9,name:'ELECTRIC SHAVER',sub:'Wet and dry rotary',price:'79.95',was:'99.95',off:20,badge:null,bg:'#E8EEF5'},
  {id:10,name:'EPILATOR PRECISION',sub:'Cordless 4-head epilator',price:'69.95',was:'89.95',off:22,badge:null,bg:'#F5EEE8'},
  {id:11,name:'BODY GROOMER',sub:'Full body groomer kit',price:'49.95',was:'64.95',off:23,badge:null,bg:'#E8F5EE'},
  {id:12,name:'LADY SHAVER',sub:'Gentle lady shaver wet/dry',price:'34.95',was:'44.95',off:22,badge:null,bg:'#F5E8EE'}
]},
{label:'MASSAGE & WELLNESS',products:[
  {id:13,name:'MASSAGE GUN',sub:'Deep tissue percussion',price:'89.95',was:'119.95',off:25,badge:null,bg:'#EDE8F5'},
  {id:14,name:'FOOT MASSAGER',sub:'Shiatsu foot massager',price:'79.95',was:'99.95',off:20,badge:null,bg:'#F0E8F5'},
  {id:15,name:'NECK MASSAGER',sub:'Electric neck and shoulder',price:'59.95',was:'79.95',off:25,badge:null,bg:'#E8F5F0'},
  {id:16,name:'SCALP MASSAGER',sub:'Electric scalp massager',price:'29.95',was:'39.95',off:25,badge:null,bg:'#F5F0EE'}
]}];
...
export default function PersonalCareScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>UP TO -27%  |  PERSONAL CARE</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>56 products</Text>
