...
const CARD_W=W/2;
const SUBS=[{label:'MINI FRIDGES',products:[
  {id:1,name:'MINI FRIDGE 60L',sub:'Compact fridge for bedroom',price:'149.95',was:'189.95',off:21,badge:null,bg:'#E8F0F5'},
  {id:2,name:'MINI FRIDGE 45L',sub:'Tabletop mini fridge',price:'119.95',was:'149.95',off:20,badge:null,bg:'#EEF5E8'},
  {id:3,name:'MINI FRIDGE BAR',sub:'Glass door bar fridge',price:'169.95',was:'214.95',off:21,badge:null,bg:'#F5EDE8'},
  {id:4,name:'MINI FRIDGE SILENT',sub:'Silent operation mini fridge',price:'139.95',was:'179.95',off:22,badge:null,bg:'#E8F5F0'}
]},
{label:'WINE COOLERS',products:[
  {id:5,name:'WINE COOLER 18',sub:'Dual zone 18 bottle cooler',price:'249.95',was:'319.95',off:22,badge:null,bg:'#F0E8F5'},
  {id:6,name:'WINE COOLER 12',sub:'Single zone 12 bottle',price:'189.95',was:'239.95',off:21,badge:null,bg:'#EDE8F5'},
  {id:7,name:'WINE COOLER 24',sub:'24 bottle wine fridge',price:'299.95',was:'379.95',off:21,badge:null,bg:'#E8F0F5'},
  {id:8,name:'WINE COOLER BUILT-IN',sub:'Built-in wine cooler',price:'349.95',was:'449.95',off:22,badge:null,bg:'#F5EDE8'}
]},
{label:'RETRO FRIDGES',products:[
  {id:9,name:'RETRO FRIDGE 100L',sub:'Vintage style fridge',price:'349.95',was:'429.95',off:19,badge:null,bg:'#F5EDE8'},
  {id:10,name:'RETRO MINI FRIDGE',sub:'Retro compact fridge 50L',price:'199.95',was:'249.95',off:20,badge:null,bg:'#EEF5E8'},
  {id:11,name:'RETRO FRIDGE PASTEL',sub:'Pastel colour retro fridge',price:'379.95',was:'479.95',off:21,badge:null,bg:'#E8F5EE'},
  {id:12,name:'RETRO FRIDGE BLACK',sub:'Matte black retro fridge',price:'399.95',was:'499.95',off:20,badge:null,bg:'#E8EDF5'}
]},
{label:'DRINKS COOLERS',products:[
  {id:13,name:'DRINKS COOLER 45L',sub:'Glass door beverage cooler',price:'199.95',was:'249.95',off:20,badge:null,bg:'#E8F5F0'},
  {id:14,name:'DRINKS COOLER 60L',sub:'Large drinks refrigerator',price:'229.95',was:'289.95',off:21,badge:null,bg:'#F5F0E8'},
  {id:15,name:'CAMPING FRIDGE 25L',sub:'Portable cooler for travel',price:'129.95',was:'159.95',off:19,badge:null,bg:'#EEF5E8'},
  {id:16,name:'COUNTERTOP FRIDGE',sub:'Small countertop fridge',price:'99.95',was:'129.95',off:23,badge:null,bg:'#F5F5E8'}
]}];
...
export default function FridgesScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>UP TO -22%  |  FRIDGES</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>28 products</Text>
