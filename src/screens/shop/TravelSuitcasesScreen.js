...
const CARD_W=W/2;
const SUBS=[{label:'CABIN SIZE',products:[
  {id:1,name:'CABIN SUITCASE 36L',sub:'Hard shell spinner cabin',price:'89.95',was:'119.95',off:25,badge:null,bg:'#EDE8F5'},
  {id:2,name:'CABIN SOFT 30L',sub:'Soft shell cabin bag',price:'69.95',was:'89.95',off:22,badge:null,bg:'#F5EDE8'},
  {id:3,name:'CABIN ALUMINIUM',sub:'Premium aluminium cabin',price:'149.95',was:'189.95',off:21,badge:null,bg:'#E8F0F5'},
  {id:4,name:'CABIN KIDS',sub:'Children cabin suitcase',price:'59.95',was:'79.95',off:25,badge:null,bg:'#F5E8E8'}
]},
{label:'MEDIUM SIZE',products:[
  {id:5,name:'MEDIUM SUITCASE 65L',sub:'4-wheel spinner medium',price:'119.95',was:'149.95',off:20,badge:null,bg:'#F5EDE8'},
  {id:6,name:'MEDIUM SOFT 60L',sub:'Soft expandable medium',price:'99.95',was:'129.95',off:23,badge:null,bg:'#E8F5ED'},
  {id:7,name:'MEDIUM ALUMINIUM',sub:'Premium aluminium medium',price:'199.95',was:'249.95',off:20,badge:null,bg:'#EDE8F5'},
  {id:8,name:'MEDIUM LIGHTWEIGHT',sub:'Ultra-light medium case',price:'109.95',was:'139.95',off:21,badge:null,bg:'#EEF5E8'}
]},
{label:'LARGE SIZE',products:[
  {id:9,name:'LARGE SUITCASE 95L',sub:'Expandable hard large',price:'149.95',was:'189.95',off:21,badge:null,bg:'#E8F5ED'},
  {id:10,name:'LARGE SOFT 90L',sub:'Soft large suitcase',price:'129.95',was:'169.95',off:24,badge:null,bg:'#F5F0E8'},
  {id:11,name:'LARGE PREMIUM',sub:'Premium large spinner',price:'179.95',was:'229.95',off:22,badge:null,bg:'#EDE8F5'},
  {id:12,name:'LARGE FAMILY',sub:'Family size 100L case',price:'169.95',was:'214.95',off:21,badge:null,bg:'#E8F0F5'}
]},
{label:'SETS & ACCESSORIES',products:[
  {id:13,name:'SET OF 3 SUITCASES',sub:'Cabin+medium+large set',price:'249.95',was:'319.95',off:22,badge:'BEST VALUE',bg:'#F5F0E8'},
  {id:14,name:'CARRY-ON BAG 30L',sub:'Flexible weekend bag',price:'69.95',was:'89.95',off:22,badge:null,bg:'#E8EDF5'},
  {id:15,name:'PACKING CUBES SET',sub:'6-piece packing cubes',price:'24.95',was:'34.95',off:29,badge:null,bg:'#F5EDE8'},
  {id:16,name:'LUGGAGE TAG SET',sub:'Leather luggage tags x4',price:'14.95',was:'19.95',off:25,badge:null,bg:'#EEF5E8'}
]}];
...
export default function TravelSuitcasesScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>UP TO -25%  |  TRAVEL SUITCASES</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>24 products</Text>
