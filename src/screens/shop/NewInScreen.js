...
const CARD_W=W/2;
const SUBS=[{label:'KITCHEN NEW IN',products:[
  {id:1,name:'AIR FRYER XL 5.5L',sub:'Digital air fryer',price:'89.95',was:'119.95',off:25,badge:'NEW',bg:'#F0EDE8'},
  {id:2,name:'ESPRESSO MACHINE',sub:'15-bar espresso',price:'149.95',was:'189.95',off:21,badge:'NEW',bg:'#EDE8F0'},
  {id:3,name:'TOASTER 4-SLICE',sub:'Wide slot toaster',price:'49.95',was:'64.95',off:23,badge:'NEW',bg:'#F5EDDE'},
  {id:4,name:'STAND MIXER 1200W',sub:'Professional mixer',price:'149.95',was:'199.95',off:25,badge:'NEW',bg:'#E8E8F5'}
]},
{label:'HEATERS NEW IN',products:[
  {id:5,name:'TOWER HEATER SMART',sub:'WiFi smart heater',price:'149.95',was:'189.95',off:21,badge:'NEW',bg:'#F0EEE8'},
  {id:6,name:'INFRARED PANEL',sub:'Slim wall panel',price:'179.95',was:'229.95',off:22,badge:'NEW',bg:'#E8EDF5'},
  {id:7,name:'PATIO HEATER ULTRA',sub:'Weatherproof outdoor',price:'249.95',was:'299.95',off:17,badge:'NEW',bg:'#F5EDDE'},
  {id:8,name:'GLASS WALL HEATER',sub:'Stylish glass panel',price:'189.95',was:'239.95',off:21,badge:'NEW',bg:'#E8EDF5'}
]},
{label:'PERSONAL CARE NEW IN',products:[
  {id:9,name:'MASSAGE GUN',sub:'Deep tissue percussion',price:'89.95',was:'119.95',off:25,badge:'NEW',bg:'#EDE8F5'},
  {id:10,name:'LED FACE MASK',sub:'7-colour LED therapy',price:'79.95',was:'99.95',off:20,badge:'NEW',bg:'#F5E8F0'},
  {id:11,name:'HAIR DRYER PRO',sub:'Professional ionic',price:'59.95',was:'79.95',off:25,badge:'NEW',bg:'#F5E8EE'},
  {id:12,name:'EPILATOR PRECISION',sub:'Cordless 4-head',price:'69.95',was:'89.95',off:22,badge:'NEW',bg:'#F5EEE8'}
]},
{label:'HOME & CLEANING NEW IN',products:[
  {id:13,name:'ROBOT VACUUM S5',sub:'Smart robot mapping',price:'249.95',was:'319.95',off:22,badge:'NEW',bg:'#F0F0F5'},
  {id:14,name:'STEAM MOP PRO',sub:'Steam mop 1500W',price:'79.95',was:'99.95',off:20,badge:'NEW',bg:'#E8F5F5'},
  {id:15,name:'AIR PURIFIER SMART',sub:'WiFi air purifier',price:'199.95',was:'259.95',off:23,badge:'NEW',bg:'#EDE8F5'},
  {id:16,name:'WINDOW ROBOT',sub:'Auto window cleaner',price:'199.95',was:'259.95',off:23,badge:'NEW',bg:'#E8EDF5'}
]},
{label:'FANS NEW IN',products:[
  {id:17,name:'SMART FAN WIFI',sub:'WiFi ceiling fan',price:'279.95',was:'349.95',off:20,badge:'NEW',bg:'#F5F0E8'},
  {id:18,name:'LED FAN RGB',sub:'Color changing LED fan',price:'219.95',was:'279.95',off:21,badge:'NEW',bg:'#F5EDE8'},
  {id:19,name:'TOWER FAN SMART',sub:'WiFi smart tower fan',price:'99.95',was:'129.95',off:23,badge:'NEW',bg:'#F5EEE8'},
  {id:20,name:'OUTDOOR FAN 52"',sub:'Weatherproof fan',price:'229.95',was:'289.95',off:21,badge:'NEW',bg:'#E8F5EE'}
]},
{label:'AUDIO NEW IN',products:[
  {id:21,name:'SOUNDBAR 2.1',sub:'120W with subwoofer',price:'149.95',was:'199.95',off:25,badge:'NEW',bg:'#F5E8E8'},
  {id:22,name:'WIRELESS HEADPHONES',sub:'Noise cancelling',price:'99.95',was:'129.95',off:23,badge:'NEW',bg:'#E8F5E8'},
  {id:23,name:'SMART TV 43" 4K',sub:'4K UHD Android TV',price:'449.95',was:'569.95',off:21,badge:'NEW',bg:'#E8EDF5'},
  {id:24,name:'DAB RADIO RETRO',sub:'Digital retro radio',price:'59.95',was:'79.95',off:25,badge:'NEW',bg:'#F0F5E8'}
]}];
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>JUST ARRIVED  |  NEW IN</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>96 products</Text>
