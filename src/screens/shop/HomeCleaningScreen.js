...
const CARD_W=W/2;
const SUBS=[{label:'ROBOT VACUUMS',products:[
  {id:1,name:'ROBOT VACUUM S5',sub:'Smart robot with mapping',price:'249.95',was:'319.95',off:22,badge:null,bg:'#F0F0F5'},
  {id:2,name:'ROBOT VACUUM BASIC',sub:'Entry level robot vacuum',price:'149.95',was:'189.95',off:21,badge:null,bg:'#E8F5F5'},
  {id:3,name:'ROBOT MOP COMBO',sub:'Vacuum and mop 2-in-1',price:'299.95',was:'379.95',off:21,badge:null,bg:'#F5F0E8'},
  {id:4,name:'ROBOT VACUUM PET',sub:'Pet hair specialist robot',price:'279.95',was:'349.95',off:20,badge:null,bg:'#EEF5EE'}
]},
{label:'STEAM CLEANERS',products:[
  {id:5,name:'STEAM MOP PRO',sub:'Steam floor mop 1500W',price:'79.95',was:'99.95',off:20,badge:null,bg:'#E8F5F5'},
  {id:6,name:'HANDHELD STEAMER',sub:'Portable steam cleaner',price:'49.95',was:'64.95',off:23,badge:null,bg:'#F5E8F5'},
  {id:7,name:'STEAM CLEANER XL',sub:'Multi-surface steam system',price:'129.95',was:'169.95',off:24,badge:null,bg:'#E8F0F5'},
  {id:8,name:'GARMENT STEAMER',sub:'Clothes steamer 1500W',price:'59.95',was:'79.95',off:25,badge:null,bg:'#F5F5E8'}
]},
{label:'AIR PURIFIERS',products:[
  {id:9,name:'AIR PURIFIER HEPA',sub:'True HEPA purifier 50m²',price:'149.95',was:'189.95',off:21,badge:null,bg:'#E8F0F5'},
  {id:10,name:'AIR PURIFIER MINI',sub:'Desktop air purifier',price:'69.95',was:'89.95',off:22,badge:null,bg:'#F5EDE8'},
  {id:11,name:'AIR PURIFIER SMART',sub:'WiFi smart air purifier',price:'199.95',was:'259.95',off:23,badge:null,bg:'#EDE8F5'},
  {id:12,name:'AIR PURIFIER CAR',sub:'Portable car air purifier',price:'39.95',was:'54.95',off:27,badge:null,bg:'#EEF5E8'}
]},
{label:'WINDOW CLEANERS',products:[
  {id:13,name:'WINDOW VAC CLEANER',sub:'Electric window vac',price:'59.95',was:'79.95',off:25,badge:null,bg:'#F5F0E8'},
  {id:14,name:'WINDOW ROBOT',sub:'Automatic window cleaner',price:'199.95',was:'259.95',off:23,badge:null,bg:'#E8EDF5'},
  {id:15,name:'SQUEEGEE PRO SET',sub:'Professional squeegee kit',price:'19.95',was:'29.95',off:33,badge:null,bg:'#F5F5E8'},
  {id:16,name:'CARPET CLEANER',sub:'Deep clean washer 800W',price:'199.95',was:'249.95',off:20,badge:null,bg:'#EEF5EE'}
]}];
...
export default function HomeCleaningScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>UP TO -25%  |  HOME & CLEANING</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>52 products</Text>
