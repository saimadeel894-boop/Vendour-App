...
const CARD_W=W/2;
const SUBS=[{label:'GARDEN TOOLS',products:[
  {id:1,name:'ELECTRIC LAWNMOWER',sub:'Corded lawnmower 1400W',price:'149.95',was:'189.95',off:21,badge:null,bg:'#E8F5E8'},
  {id:2,name:'HEDGE TRIMMER',sub:'Cordless trimmer 18V',price:'89.95',was:'114.95',off:22,badge:null,bg:'#EEF5E8'},
  {id:3,name:'LEAF BLOWER',sub:'Cordless leaf blower 20V',price:'79.95',was:'99.95',off:20,badge:null,bg:'#E8F0E8'},
  {id:4,name:'GRASS TRIMMER',sub:'Electric grass strimmer',price:'49.95',was:'64.95',off:23,badge:null,bg:'#F5F5E8'}
]},
{label:'OUTDOOR LIGHTING',products:[
  {id:5,name:'SOLAR LIGHTS SET',sub:'6 solar LED garden lights',price:'39.95',was:'54.95',off:27,badge:null,bg:'#F5F5E8'},
  {id:6,name:'STRING LIGHTS',sub:'20m outdoor string lights',price:'29.95',was:'39.95',off:25,badge:null,bg:'#F0F5E8'},
  {id:7,name:'WALL LIGHT SOLAR',sub:'Solar wall light 2-pack',price:'24.95',was:'34.95',off:29,badge:null,bg:'#E8F5F0'},
  {id:8,name:'PATHWAY LIGHTS',sub:'Solar pathway lights x8',price:'34.95',was:'44.95',off:22,badge:null,bg:'#EEF5E8'}
]},
{label:'IRRIGATION',products:[
  {id:9,name:'PRESSURE WASHER',sub:'High pressure 130 bar',price:'129.95',was:'169.95',off:24,badge:null,bg:'#E8EEF5'},
  {id:10,name:'GARDEN HOSE 30M',sub:'Expandable hose with gun',price:'29.95',was:'39.95',off:25,badge:null,bg:'#E8F5E8'},
  {id:11,name:'SPRINKLER SYSTEM',sub:'Auto garden sprinkler',price:'39.95',was:'54.95',off:27,badge:null,bg:'#F5F0E8'},
  {id:12,name:'WATER PUMP',sub:'Submersible pump 1000L/h',price:'49.95',was:'64.95',off:23,badge:null,bg:'#E8F5F0'}
]},
{label:'OUTDOOR HEATING',products:[
  {id:13,name:'OUTDOOR HEATER',sub:'Free standing patio heater',price:'199.95',was:'249.95',off:20,badge:'UK ADAPTER',bg:'#F5EDE8'},
  {id:14,name:'FIRE PIT TABLE',sub:'Gas fire pit table',price:'299.95',was:'379.95',off:21,badge:null,bg:'#EDE8E8'},
  {id:15,name:'CHIMINEA',sub:'Clay chiminea 90cm',price:'89.95',was:'114.95',off:22,badge:null,bg:'#F5F0EE'},
  {id:16,name:'PATIO TORCH SET',sub:'Solar flame torches x4',price:'39.95',was:'54.95',off:27,badge:null,bg:'#E8F5E8'}
]}];
...
export default function GardenOutdoorScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>UP TO -24%  |  GARDEN & OUTDOOR</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>36 products</Text>
