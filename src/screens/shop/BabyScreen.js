...
const CARD_W=W/2;
const SUBS=[{label:'MONITORS & SAFETY',products:[
  {id:1,name:'BABY MONITOR HD',sub:'720p WiFi monitor',price:'89.95',was:'114.95',off:22,badge:'NEW',bg:'#FFF0E8'},
  {id:2,name:'BABY MONITOR AUDIO',sub:'Audio only monitor',price:'39.95',was:'54.95',off:27,badge:'NEW',bg:'#F0FFF0'},
  {id:3,name:'MOVEMENT SENSOR',sub:'Breathing movement pad',price:'69.95',was:'89.95',off:22,badge:'NEW',bg:'#F0F0FF'},
  {id:4,name:'ROOM THERMOMETER',sub:'Digital nursery thermometer',price:'19.95',was:'29.95',off:33,badge:'NEW',bg:'#FFFAF0'}
]},
{label:'FEEDING',products:[
  {id:5,name:'BOTTLE STERILISER',sub:'Steam steriliser 6 bottles',price:'49.95',was:'64.95',off:23,badge:'NEW',bg:'#F0FFF0'},
  {id:6,name:'BABY FOOD MAKER',sub:'Steam blender baby food',price:'69.95',was:'89.95',off:22,badge:'NEW',bg:'#F0F0FF'},
  {id:7,name:'BOTTLE WARMER',sub:'Fast bottle warmer',price:'29.95',was:'39.95',off:25,badge:'NEW',bg:'#FFFAF0'},
  {id:8,name:'FORMULA MAKER',sub:'Auto formula dispenser',price:'99.95',was:'129.95',off:23,badge:'NEW',bg:'#FFF0E8'}
]},
{label:'NURSERY',products:[
  {id:9,name:'NIGHT LIGHT',sub:'Star projector with music',price:'34.95',was:'44.95',off:22,badge:'NEW',bg:'#FFF0F0'},
  {id:10,name:'BABY HUMIDIFIER',sub:'Cool mist for nursery',price:'44.95',was:'59.95',off:24,badge:'NEW',bg:'#F0FFF5'},
  {id:11,name:'WHITE NOISE',sub:'White noise sound machine',price:'29.95',was:'39.95',off:25,badge:'NEW',bg:'#F0F5FF'},
  {id:12,name:'BABY SCALE',sub:'Digital baby weighing scale',price:'49.95',was:'64.95',off:23,badge:'NEW',bg:'#FFFAF0'}
]}];
...
export default function BabyScreen({navigate}){
...
<View style={s.db}><Text style={s.dbt}><Text style={s.b}>NEW IN  |  BABY</Text></Text>
...
<View style={s.cr}><Text style={s.crt}>22 products</Text>
